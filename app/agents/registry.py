...
from app.agents.nodes import (
    ...
    handle_candidate_review_placeholder,
    handle_document_qa_placeholder,
...
INTENT_NODE_REGISTRY: dict[AgentIntent, AgentNode] = {
    ...
    AgentIntent.DOCUMENT_QA: handle_document_qa_placeholder,
    AgentIntent.CANDIDATE_REVIEW: handle_candidate_review_placeholder,
